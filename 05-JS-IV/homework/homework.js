...
function tieneEmail(usuario) {
  ...
  if(usuario.email) return true //Significa que existe información, la cual por definición es true
  else return false
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
  var suma = 0
  var arrayPosts = usuario.posts //Capturé el arreglo para que sea más fácil.
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  }       //Modifico precio para que tenga el valor de descuento. No tiene sentido que precio sea el valor antiguo.
  return producto
